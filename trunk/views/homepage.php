...
<body>
	<div align="center"><h2>Admin Login Page</h2></div>
	<div align="center">
		<form method="post" action="index.php" id="adminlogin" name="adminlogin">
			...
			<div>
				Admin Login | <a href="index.php?c=homeController&action=userlogin">User Login</a> | <a href="index.php?c=homeController&action=trainerlogin">Trainer Login</a>
			</div>
